  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      const res = await fn({
        ...
        ciudad: createCiudad.trim().toUpperCase(),
        sede: createSede.trim().toUpperCase(),
        area: createArea.trim().toUpperCase(),
        cargoRecibe: createCargoRecibe.trim().toUpperCase(),
        observaciones: createObs.toUpperCase(),
